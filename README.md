...
Within the Example Notebooks folder there are 2 python notebooks. One for VAMPIRE-X and one for VAMPIRE-E, with thresholds at the 60th percentile as first described in Weston et al. 2025 [![DOI](https://img.shields.io/badge/DOI-10.1029/2025SW004607-blue)](https://doi.org/10.1029/2025SW004607) where the threshold is set and downloads datasets and pretrained forests from https://zenodo.org/records/15130352.
